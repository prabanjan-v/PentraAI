...
- ssrf          : Test SSRF — params that make the server fetch a URL (url/webhook/api/image/import), crAPI contact_mechanic
- bfla          : Test broken function-level authorization — privileged/admin endpoints (/admin, /manage, users/all, orders/all) reachable by a normal or unauthenticated user
