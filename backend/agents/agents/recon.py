...
from agents.recon_enrich import enrich_recon
...
FUZZ_PATHS = [
    ...
    "/actuator/mappings",
    # Microservice / namespaced API patterns
    # These cover crAPI-style apps AND real bug bounty targets
    # that use service-prefixed routes
    ...
    "/community/api/v2/community/posts/w2",
    ...
    # Generic microservice prefixes (common in real bug bounty)
    "/auth/api/v1/login", "/auth/api/v1/register",
    "/user/api/v1/profile", "/user/api/v1/me",
    "/order/api/v1/orders", "/order/api/v1/orders/all",
    "/payment/api/v1/transactions",
    "/notification/api/v1/notifications",
    "/shop/api/v1/products", "/shop/api/v1/orders",
    "/store/api/v1/products",
    # Common coupon/voucher endpoints (race condition targets)
    "/api/coupon/apply", "/api/coupons/apply",
    "/api/voucher/redeem", "/api/vouchers/redeem",
    "/api/promo/apply", "/api/discount/apply",
    "/api/shop/coupon", "/api/store/coupon",
    # Common order endpoints (race condition targets)
    "/api/orders/checkout", "/api/checkout",
    "/api/orders/place", "/api/order/create",
    # Common wallet/credit endpoints (race condition targets)
    "/api/wallet/credit", "/api/wallet/transfer",
    "/api/credits/add", "/api/balance/add",
]
...
async def run_recon(target_url: str) -> dict:
    ...
    # Option A enrichment: OpenAPI/Swagger, parameters, JS secrets
    results = await enrich_recon(results, target_url)
